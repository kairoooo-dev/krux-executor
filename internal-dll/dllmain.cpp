// KRUX internal DLL base — vendored from TaaprWare V3 (plusgiant5, MIT-ish, see LICENSE.TaaprWare.txt).
// Pipe mode enabled so the KRUX WinForms GUI can send scripts via \\.\pipe\KruxInternal.
